...
#
# Usage: cd louvain/real_graphs/snap && bash run_benchmarks.sh
#        Or: bash real_graphs/snap/run_benchmarks.sh  (from louvain/)
...
SEED=42
NX_SKIP_ABOVE=5000000  # skip NetworkX above this many initial edges (too slow)
